...
这个 skill 默认假设当前环境已经安装并可调用 `mpau` 命令。
...
```bash
mpau bilibili login --account <account>
```
...
```bash
mpau bilibili check --account <account>
```
